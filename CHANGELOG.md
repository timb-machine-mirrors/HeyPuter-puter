...
* **aws/polly:** add new apis to puter-js, add new args to txt2speech ([#1337](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/1337)) ([0b6dbe5](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/0b6dbe587a943f3b283be382fc12690034ec26c0))
...
* **gui:** Add animation effects to the taskbar ([#1365](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/1365)) ([212bc88](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/212bc88c8f7561a7b1dc9bac3d5308ec2275c8e1))
* implement authentication UI in Puter.js's test UI ([3def1d4](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/3def1d4d7c03f784f26edbb802f2478aa16f0eea))
* implement settings management and modal in puter.js test framework ([9ca1f06](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/9ca1f0639a92a0ea5ce43081a4f43e33b02dc08f))
* puter workers ([bddc872](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/bddc872e009abecffc8517a55d5222025fc113e7))
...
* 1231 ([9a84776](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/9a847760bceefcd13f174bebfdc1ecd5708fa5be))
...
* add missing unit conversion step ([4b5955b](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/4b5955b45963711bc5d19b0f242971b39be1b058))
* add necessary supporting code for funding update ([1c19086](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/1c1908659262ff1ae7a89191b5adc6c025bd5e98))
* add one I missed previous commit ([5b7b524](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/5b7b52408003c173ec21aa74f5eb756ecf8d77cd))
* add safeguard in case server response is wrong ([cbfb928](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/cbfb9283d10f248976d28f8ab55b5d1c83ca1980))
* add support for new Endpoint usage ([db960d5](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/db960d585a244716e683ac726b25c5e3aba57f95))
...
* arrow key navigation ([ae07a5e](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/ae07a5e316a16cfff281c25f9b4674f24fe93b65))
* arrow keys unresponsive when selecting items with offset center points ([5fd5017](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/5fd50170801813e29e6c309d0f4e840cf7506eef))
...
* build error ([5f14dc7](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/5f14dc720be1583f33d9da23bbc59167b0635d8c))
* cannot create shortcut for shared file ([72a4550](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/72a45500d5db68215e1d6c9638a8c629acff9e2d)), closes [#1263](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/1263)
...
* complete Norwegian Nynorsk translation ([807d7bd](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/807d7bd698a75f011cbbb1df1de3322701088727))
...
* cost testing model ([f46d47d](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/f46d47d2a8fefee01f1b5570018a6b5c4144e83d))
...
* enable and fix date command tests ([d885ea5](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/d885ea5772b9aab6dce3092139309df79753d701)), closes [#796](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/796)
...
* fallback behavior related to fake-chat service ([9bf48e7](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/9bf48e7289cef34b0f1527a5dc0792a7ebf14710))
* file cleanup for Claude when streaming ([50d520f](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/50d520f09935f34bad6420ec8c8373ba2ed7e13c))
...
* get sharp far away from bundlers as possible ([963b248](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/963b248582a8d2aec67261ca171d48076575b84d))
* gone ([34787bb](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/34787bbb0cfc08dc9e35128ed6549c18709d60a1))
...
* improvements to jaeger trace service ([fd956cb](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/fd956cb1cd23d28b935c3693c29c10208845261f))
* include base reserved words by default ([c7970fd](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/c7970fd1a830dfcbe0e031007bceafeb97bb8084))
...
* incorrect call to APIError from configurable_auth ([5903f1f](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/5903f1fb31eb1cbbcb0d346ebefc716c9d6e68ad))
* incorrect pricing ([ae4dc23](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/ae4dc23c378c624bd6aa76bd45d201d476445a25))
* install ([2d9526b](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/2d9526ba404bead5beaa87c86712dee4984b28dc))
* issue using ll_write outside of hl_write ([152a557](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/152a5578fce30dff0c183db81b52fc8332947a52))
...
* make sharp optional ([354b116](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/354b116b424243fac989009612b0e457d0e54e8c))
...
* necessary updates happen for move save too ([6598798](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/659879812dcf77578103e58d8b9f667c91a8c589))
...
* pass dedupe_name to mkshortcut via batch ([cecc9f2](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/cecc9f23dca4f07b289355d74b60db626871c931))
...
* prevent health check from surpressing traces ([2cd5b3c](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/2cd5b3cb498ca5511b0120b4a007512837e1558f))
* properly update owner object in FSNodeContext ([d17b466](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/d17b466e37eb153bfd0ec3256ed040d0fa4e5291))
...
* remaining issues with fake-chat/costly ([7f6b302](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/7f6b3026364b6c4dee8e622aaeec1d039e3ac054))
* remove dormant condition operand from signup.js ([a7d1bf0](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/a7d1bf0e99931f5dda5ec5ed0b3e894b54c82e0d))
* remove duplicate icons and hide .weblink extension ([bf16e20](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/bf16e2044737001423e7c12c2105878c36aa9e35))
...
* return proper error message when the model is not found ([#1331](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/1331)) ([ade213b](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/ade213b88b82d44139c54ed55992745379d78548)), closes [#1326](https://github.com/timb-machine-mirrors/HeyPuter-puter/issues/1326)
* save_account lock timeout ([ccdb678](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/ccdb678937b9742e30061ae39fb7c710389f720c))
...
* share issue ([518449c](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/518449cfdd1e3ccb8240a8865069e2bb524f8725))
* shortcut KV permissions ([f6e6e8d](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/f6e6e8dff829eb86a4bfa7129f01e4c0b18517db))
...
* sqlite syntax inconsistency ([75aebd6](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/75aebd6d35f97ff376fc393498031993ba9707b3))
* streaming in FakeChatService ([2e90e8d](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/2e90e8dc960fb18abe3f2120a78df3ddc9085093))
...
* ui bug in settings window ([77f3bf2](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/77f3bf21770d26b82be32b110ebd4b880e6d348b))
...
* update package-lock.json ([60a9be1](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/60a9be12badd168446bd8a416cc67dd2c50487a8))
...
* update refresh_actor cache invalidation ([405564f](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/405564f55fb9ba3b3bcac67774b12d16a69e9724))
* use correct path for openrouter max tokens ([3f5de6d](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/3f5de6d493f7de34e1f2b7924c29d36f97dd14e8))
...
* various AI fixes ([4312280](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/43122801bf9dc207843e95fa2f881ff212763b36))
...
* wrong symbol in previous commit ([ca3acf1](https://github.com/timb-machine-mirrors/HeyPuter-puter/commit/ca3acf13c14db089f7ce601de38f470e59988f89))
